...
(* OASIS_START *)
(* DO NOT EDIT (digest: a1388e7c12e68990989d167523eb9538) *)
(*
...
let setup_t =
  {
     ...
     doc =
       [
          ("counterparty-full-api",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "src"});
          ("counterparty-ocamlnet-api",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "src"});
          ("counterparty-ocsigen-api",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "src"});
          ("counterparty-cohttp-api",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "src"});
          ("counterparty-api",
            OCamlbuildDocPlugin.doc_build
            ...
            [
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Build auxiliary library \"counterparty_ocsigen\" (implements an HTTP client using Ocsigenserver's Ocsigen_http_client)";
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Build auxiliary library \"counterparty_ocamlnet\" (implements an HTTP client using Ocamlnet's Netclient)";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Build auxiliary library \"counterparty_cohttp\" (implements an HTTP client using Cohttp's Cohttp_lwt_unix.Client)";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Build auxiliary library \"counterparty_ocurl\" (implements an HTTP client using OCurl)";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                     cs_name = "counterparty";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Counterparty_ocsigen"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "counterparty";
                      lib_findlib_name = Some "ocsigen";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "counterparty_ocamlnet";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Counterparty_ocamlnet"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "counterparty";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Counterparty_cohttp"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "counterparty";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Counterparty_ocurl"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "counterparty";
                      lib_findlib_name = Some "ocurl";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                     cs_name = "counterparty-full-api";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Doc
                 ({
                     cs_name = "counterparty-ocamlnet-api";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Doc
                 ({
                     cs_name = "counterparty-ocsigen-api";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Doc
                 ({
                     cs_name = "counterparty-cohttp-api";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "counterparty_ocamlnet"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamldoc"];
                      bs_c_sources = [];
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "øEº¹g\022¯\003¬\002\149T²m°ü";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
